...
string STreeNode::path()
{
	if (!parent_)
		...
		return parent_->path() + name().to_string() + '/';
}

// -----------------------------------------------------------------------------
// Returns the child node at [index], or NULL if index is invalid
// -----------------------------------------------------------------------------
STreeNode* STreeNode::childAt(unsigned index)
{
	// Check index
...
// -----------------------------------------------------------------------------
// Returns the child node matching [name]. Can also find deeper child nodes if a
// path is given in [name]. Returns NULL if no match is found
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Returns a list of all the node's children matching [name]. Also handles paths
// as per getChild
// -----------------------------------------------------------------------------
