...
// Description: C++ implementations of CIE Delta E colour difference equations.
//              Since they are meant for comparison of differences to find the
//              closest match in a palette, these lack the final sqrt() of the
//              result.
//
...
double CIE::CIEDE2000(ColLAB& col1, ColLAB& col2)
{
	...
	// Compute T
	double t = 1.0 - 0.17 * cos(hpavg - (PI / 6.0)) + 0.24 * cos(hpavg * 2.0) + 0.32 * cos(hpavg * 3.0 + (PI / 30.0))
...
/*	Log::info(	// Fun fact: this call hits the parameter limit for wx's log system. One more and it breaks.
...
{
	ColLAB labs[34][2] = {
		{ ColLAB(50.0000, 2.6772, -79.7751), ColLAB(50.0000, 0.0000, -82.7485) },   //   1
		{ ColLAB(50.0000, 3.1571, -77.2803), ColLAB(50.0000, 0.0000, -82.7485) },   //   2
		{ ColLAB(50.0000, 2.8361, -74.0200), ColLAB(50.0000, 0.0000, -82.7485) },   //   3
		{ ColLAB(50.0000, -1.3802, -84.2814), ColLAB(50.0000, 0.0000, -82.7485) },  //   4
		{ ColLAB(50.0000, -1.1848, -84.8006), ColLAB(50.0000, 0.0000, -82.7485) },  //   5
		{ ColLAB(50.0000, -0.9009, -85.5211), ColLAB(50.0000, 0.0000, -82.7485) },  //   6
		{ ColLAB(50.0000, 0.0000, 0.0000), ColLAB(50.0000, -1.0000, 2.0000) },      //   7
		{ ColLAB(50.0000, -1.0000, 2.0000), ColLAB(50.0000, 0.0000, 0.0000) },      //   8
		{ ColLAB(50.0000, 2.4900, -0.0010), ColLAB(50.0000, -2.4900, 0.0009) },     //   9
		{ ColLAB(50.0000, 2.4900, -0.0010), ColLAB(50.0000, -2.4900, 0.0010) },     //  10
		{ ColLAB(50.0000, 2.4900, -0.0010), ColLAB(50.0000, -2.4900, 0.0011) },     //  11
		{ ColLAB(50.0000, 2.4900, -0.0010), ColLAB(50.0000, -2.4900, 0.0012) },     //  12
		{ ColLAB(50.0000, -0.0010, 2.4900), ColLAB(50.0000, 0.0009, -2.4900) },     //  13
		{ ColLAB(50.0000, -0.0010, 2.4900), ColLAB(50.0000, 0.0010, -2.4900) },     //  14
		{ ColLAB(50.0000, -0.0010, 2.4900), ColLAB(50.0000, 0.0011, -2.4900) },     //  15
		{ ColLAB(50.0000, 2.5000, 0.0000), ColLAB(50.0000, 0.0000, -2.5000) },      //  16
		{ ColLAB(50.0000, 2.5000, 0.0000), ColLAB(73.0000, 25.0000, -18.0000) },    //  17
		{ ColLAB(50.0000, 2.5000, 0.0000), ColLAB(61.0000, -5.0000, 29.0000) },     //  18
		{ ColLAB(50.0000, 2.5000, 0.0000), ColLAB(56.0000, -27.0000, -3.0000) },    //  19
		{ ColLAB(50.0000, 2.5000, 0.0000), ColLAB(58.0000, 24.0000, 15.0000) },     //  20
		{ ColLAB(50.0000, 2.5000, 0.0000), ColLAB(50.0000, 3.1736, 0.5854) },       //  21
		{ ColLAB(50.0000, 2.5000, 0.0000), ColLAB(50.0000, 3.2972, 0.0000) },       //  22
		{ ColLAB(50.0000, 2.5000, 0.0000), ColLAB(50.0000, 1.8634, 0.5757) },       //  23
		{ ColLAB(50.0000, 2.5000, 0.0000), ColLAB(50.0000, 3.2592, 0.3350) },       //  24
		{ ColLAB(60.2574, -34.0099, 36.2677), ColLAB(60.4626, -34.1751, 39.4387) }, //  25
		{ ColLAB(63.0109, -31.0961, -5.8663), ColLAB(62.8187, -29.7946, -4.0864) }, //  26
		{ ColLAB(61.2901, 3.7196, -5.3901), ColLAB(61.4292, 2.2480, -4.9620) },     //  27
		{ ColLAB(35.0831, -44.1164, 3.7933), ColLAB(35.0232, -40.0716, 1.5901) },   //  28
		{ ColLAB(22.7233, 20.0904, -46.6940), ColLAB(23.0331, 14.9730, -42.5619) }, //  29
		{ ColLAB(36.4612, 47.8580, 18.3852), ColLAB(36.2715, 50.5065, 21.2231) },   //  30
		{ ColLAB(90.8027, -2.0831, 1.4410), ColLAB(91.1528, -1.6435, 0.0447) },     //  31
		{ ColLAB(90.9257, -0.5406, -0.9208), ColLAB(88.6381, -0.8985, -0.7239) },   //  32
		{ ColLAB(6.7747, -0.2908, -2.4247), ColLAB(5.8714, -0.0985, -2.2286) },     //  33
		{ ColLAB(2.0776, 0.0795, -1.1350), ColLAB(0.9033, -0.0636, -0.5514) },      //  34
	};
