...
// -----------------------------------------------------------------------------
FileMonitor::FileMonitor(string_view filename, bool start) :
...
//
// A specialisation of FileMonitor to handle maps open externally in Doom
// Builder 2. When the file (in this case, a wad file) is modified, its map data
// is read back in to the parent archive
// -----------------------------------------------------------------------------
...
DB2MapFileMonitor::DB2MapFileMonitor(string_view filename, Archive* archive, string_view map_name) :
	...
	archive_{ archive },
	map_name_{ map_name.data(), map_name.size() }
{
}
