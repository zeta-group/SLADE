...
template<std::size_t I> inline in_place_t in_place(detail::in_place_index_tag<I> = detail::in_place_index_tag<I>())
{
	return in_place_t();
}
...
#undef variant_ALIGN_TYPE
		...
		template<class T0, class T1, class T2, class T3, class T4, class T5, class T6> struct helper
		{
			...
			template<std::size_t I, class... Args> static type_index_t construct_i(void* data, Args&&... args)
			{
	...
	template<class T0, class T1, class T2, class T3, class T4, class T5, class T6> class variant;
	...
	struct variant_size<variant<T0, T1, T2, T3, T4, T5, T6>>
	{
		enum
		{
			value = detail::typelist_size<variant_TL7(T0, T1, T2, T3, T4, T5, T6)>::value
		};
	};
...
#define variant_alternative_T(I, T) typename nonstd::variant_alternative<I, T>::type
	...
	public:
		...
		variant(variant const& rhs) : type_index(rhs.type_index)
		{
		...
		template<std::size_t I> using type_at_t = typename detail::typelist_type_at<variant_types, I>::type;
		...
		template<
			...
			typename = typename std::enable_if<
				std::is_constructible<type_at_t<I>, std::initializer_list<U>&, Args...>::value>::type>
		...
		~variant() { helper_type::destroy(index(), ptr()); }

		variant& operator=(variant const& rhs) { return copy_assign(rhs); }

#if variant_CPP11_OR_GREATER

		variant& operator=(variant&& rhs) { return move_assign(std::forward<variant>(rhs)); }
		...
		std::size_t index() const { return variant_npos_internal() == type_index ? variant_npos : type_index; }
		...
		template<class T> variant_constexpr std::size_t index_of() const variant_noexcept
		{
		...
		template<std::size_t I> typename variant_alternative<I, variant>::type& get()
		{
			return this->template get<typename detail::typelist_type_at<variant_types, I>::type>();
		}

		template<std::size_t I> typename variant_alternative<I, variant>::type const& get() const
		{
			return this->template get<typename detail::typelist_type_at<variant_types, I>::type>();
		}
	...
	private:
		...
		variant_constexpr std::size_t max_index() const variant_noexcept { return data_size; }
		...
		template<class T, std::size_t I> variant& move_assign_value(T&& value)
		{
			if (index() == I)
			{
...
#else
		template<class T, std::size_t I> variant& copy_assign_value(T const& value)
		{
			if (index() == I)
			{
				*as<T>() = value;
	...
	template<std::size_t I, class T0, class T1, class T2, class T3, class T4, class T5, class T6>
	inline typename variant_alternative<I, variant<T0, T1, T2, T3, T4, T5, T6>>::type& get(
		variant<T0, T1, T2, T3, T4, T5, T6>& v,
	...
	template<std::size_t I, class T0, class T1, class T2, class T3, class T4, class T5, class T6>
	inline typename variant_alternative<I, variant<T0, T1, T2, T3, T4, T5, T6>>::type const& get(
	...
	template<class T, class T0, class T1, class T2, class T3, class T4, class T5, class T6>
	inline typename detail::add_pointer<T>::type get_if(
		variant<T0, T1, T2, T3, T4, T5, T6>* pv,
	...
	template<class T, class T0, class T1, class T2, class T3, class T4, class T5, class T6>
	inline typename detail::add_pointer<const T>::type get_if(
		variant<T0, T1, T2, T3, T4, T5, T6> const* pv,
		nonstd_lite_in_place_type_t(T) = in_place<T>)
	{
		return (pv->index() == pv->template index_of<T>()) ? &get<T>(*pv) : variant_nullptr;
	}
	...
	template<std::size_t I, class T0, class T1, class T2, class T3, class T4, class T5, class T6>
	inline typename detail::add_pointer<
		const typename variant_alternative<I, variant<T0, T1, T2, T3, T4, T5, T6>>::type>::type
	...
	inline void swap(variant<T0, T1, T2, T3, T4, T5>& a, variant<T0, T1, T2, T3, T4, T5>& b) variant_noexcept
	{
		a.swap(b);
	}
	...
	template<class Visitor, class Variant> inline Variant visit(Visitor const& vis, Variant const& v)
	{
	...
	template<class T0, class T1, class T2, class T3, class T4, class T5, class T6>
	inline bool operator==(variant<T0, T1, T2, T3, T4, T5, T6> const& v, variant<T0, T1, T2, T3, T4, T5, T6> const& w)
	{
		if (v.index() != w.index())
			return false;
			...
			return detail::Comparator<variant<T0, T1, T2, T3, T4, T5, T6>>::equal(v, w);
	}
	...
	inline bool operator<(variant<T0, T1, T2, T3, T4, T5, T6> const& v, variant<T0, T1, T2, T3, T4, T5, T6> const& w)
	{
		if (w.valueless_by_exception())
			...
			return detail::Comparator<variant<T0, T1, T2, T3, T4, T5, T6>>::less_than(v, w);
	}
