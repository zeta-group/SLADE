...
// Description: SIFormat class - a base class for working with various image
//              formats, including loading and saving to/from SImage,
//              conversion, detection, etc.
//
...
// SIFormat Classes
//
// These are all put in categorised header files otherwise SIFormat.cpp would
// be huge
// -----------------------------------------------------------------------------
...
// detected. This uses FreeImage to detect the image type
// -----------------------------------------------------------------------------
...
protected:
	static bool validSize(unsigned size)
	{
...
// -----------------------------------------------------------------------------
SIFormat::SIFormat(string_view id, string_view name, string_view extension, uint8_t reliability) :
	id_{ id.data(), id.size() },
	name_{ name.data(), name.size() },
	extension_{ extension.data(), extension.size() },
