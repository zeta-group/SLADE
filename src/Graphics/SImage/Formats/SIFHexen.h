...
protected:
	bool readImage(SImage& image, MemChunk& data, int index) override
	{
		...
		const uint8_t* src1 = data.data() + 48; // 80: 10000000	08: 00001000
		const uint8_t* src2 = src1 + plane_size;   // 40: 01000000 04: 00000100
		const uint8_t* src3 = src2 + plane_size;   // 20: 00100000 02: 00000010
		const uint8_t* src4 = src3 + plane_size;   // 10: 00010000 01: 00000001
	...
	bool writeImage(SImage& image, MemChunk& out, Palette* pal, int index) override
	{
		...
		uint8_t* read = imageData(image);
		uint8_t* pln1 = planes;            // 80: 10000000	08: 00001000
		uint8_t* pln2 = pln1 + plane_size; // 40: 01000000 04: 00000100
		uint8_t* pln3 = pln2 + plane_size; // 20: 00100000 02: 00000010
		uint8_t* pln4 = pln3 + plane_size; // 10: 00010000 01: 00000001
