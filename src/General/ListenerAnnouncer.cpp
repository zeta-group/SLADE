...
//              communication between underlying classes (archives, etc) and UI
//              elements, without them needing to know about eachother.
//
...
// -----------------------------------------------------------------------------
// 'Announces' an event to all listeners currently in the listeners list, ie all
// Listeners that are 'listening' to this announcer.
// -----------------------------------------------------------------------------
