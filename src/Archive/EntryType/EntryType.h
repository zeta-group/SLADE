...
private:
	...
	PropertyList extra_; // Extra properties for types with certain special behaviours
						 ...
						 // bool "image": Can be loaded into a SImage, therefore can be converted to other supported
						 // image formats bool "patch": Can be used as a TEXTUREx patch string "image_format": An
						 // SIFormat type id 'hint', mostly used for Misc::loadImageFromEntry
