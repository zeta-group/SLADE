...
void ACSPrefsPanel::init()
{
	...
	list_inc_paths_->Set(wxSplit(path_acc_libs.value.c_str(), ';'));
}
...
void ACSPrefsPanel::setupLayout()
{
	...
	// ACC.exe path
	sizer->Add(WxUtils::createLabelVBox(this, "Location of acc executable:", flp_acc_path_),
			   0,
			   wxEXPAND | wxBOTTOM,
			   UI::pad());
