...
{
	cp_colour1_->SetColour(wxColour(bgtx_colour1.value));
	cp_colour2_->SetColour(wxColour(bgtx_colour2.value));
...
void GraphicsPrefsPanel::applyPreferences()
{
	...
	bgtx_colour1 = wxc.GetAsString().ToStdString();
	wxc          = cp_colour2_->GetColour();
	bgtx_colour2 = wxc.GetAsString().ToStdString();
