...
void AudioPrefsPanel::applyPreferences()
{
	...
	snd_timidity_options = text_timidity_options_->GetValue().ToStdString();
}
...
void AudioPrefsPanel::setupLayout()
{
	...
	sizer->Add(new wxStaticLine(this, -1, wxDefaultPosition, wxDefaultSize, wxHORIZONTAL),
			   0,
