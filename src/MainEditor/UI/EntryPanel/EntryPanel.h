...
{
public:
	EntryPanel(wxWindow* parent, string_view id);
	~EntryPanel();

	const string& name() const { return id_; }
	...
	const string&  getCustomMenuName() const { return custom_menu_name_; }
	void           callRefresh() { refreshPanel(); }
	void           nullEntry() { entry_ = nullptr; }
	virtual bool   undo() { return false; }
	virtual bool   redo() { return false; }
	void           updateToolbar();
	virtual void   toolbarButtonClick(string_view action_id) {}
...
protected:
	...
	virtual void onAnnouncement(Announcer* announcer, string_view event_name, MemChunk& event_data) override {}
