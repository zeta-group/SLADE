...
public:
	...
	fpoint2_t cameraPos2D() const { return { renderer_3d_.camPosition().x, renderer_3d_.camPosition().y }; }
	fpoint2_t cameraDir2D() const { return renderer_3d_.camDirection(); }
...
private:
	...
	void drawLineLength(fpoint2_t p1, fpoint2_t p2, ColRGBA col) const;
