...
bool MapObject::boolProperty(const string& key)
{
	...
	return prop ? prop->defaultValue().boolValue() : false;
}
...
{
	return remove ? obj_backup_.release() : obj_backup_.get();
}
...
// returns false
// -----------------------------------------------------------------------------
bool MapObject::multiBoolProperty(vector<MapObject*>& objects, const string& prop, bool& value)
{
	// Check objects given
	if (objects.empty())
		return false;
...
// returns false
// -----------------------------------------------------------------------------
bool MapObject::multiIntProperty(vector<MapObject*>& objects, const string& prop, int& value)
{
	// Check objects given
	if (objects.empty())
		return false;
...
// returns false
// -----------------------------------------------------------------------------
bool MapObject::multiFloatProperty(vector<MapObject*>& objects, const string& prop, double& value)
{
	// Check objects given
	if (objects.empty())
		return false;
...
// returns false
// -----------------------------------------------------------------------------
bool MapObject::multiStringProperty(vector<MapObject*>& objects, const string& prop, string& value)
{
	// Check objects given
	if (objects.empty())
		return false;
