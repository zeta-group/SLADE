...
// -----------------------------------------------------------------------------
bool ObjectEditGroup::getNearestLine(const fpoint2_t& pos, double min, fpoint2_t& v1, fpoint2_t& v2)
{
	double min_dist = min;
	for (auto& line : lines_)
	{
...
// -----------------------------------------------------------------------------
void ObjectEditGroup::doRotate(const fpoint2_t& p1, const fpoint2_t& p2, bool lock45)
{
	// Get midpoint
