...
public:
	...
	const point2_t& mousePrevPos() const { return mouse_prev_; }
	...
	point2_t screenToTexPosition(int x, int y) const;
	point2_t texToScreenPosition(int x, int y) const;
...
private:
	...
	vector<uint8_t>         selected_patches_;
	...
	ViewType                view_type_    = ViewType::Normal;
