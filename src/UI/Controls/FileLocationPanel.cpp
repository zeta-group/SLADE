...
FileLocationPanel::FileLocationPanel(
	...
	string_view path,
	bool        editable,
	string_view browse_caption,
	string_view browse_extensions,
	string_view browse_default_filename) :
	wxPanel(parent, -1),
	...
	browse_default_filename_{ browse_default_filename }
{
	...
	text_path_ = new wxTextCtrl(
		this, -1, WxUtils::stringFromView(path), wxDefaultPosition, wxDefaultSize, editable ? 0 : wxTE_READONLY);
...
{
	return text_path_->GetValue().ToStdString();
}
