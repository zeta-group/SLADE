...
//              an integer, with an optional '++' or '--' in front to signify
...
// the number
// -----------------------------------------------------------------------------
int NumberTextCtrl::getNumber(int base) const
{
	auto val = GetValue();
...
// the number
// -----------------------------------------------------------------------------
double NumberTextCtrl::getDecNumber(double base) const
{
