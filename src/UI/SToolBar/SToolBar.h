...
{
public:
	SToolBarGroup(SToolBar* parent, string_view name, bool force_name = false);
	...
	SToolBarButton* addActionButton(string_view action, string_view icon = "", bool show_name = false);
...
public:
	...
	SToolBarGroup* group(string_view name);
	void           addGroup(SToolBarGroup* group);
	void           deleteGroup(string_view name);
	void           deleteCustomGroups();
	void           addActionGroup(string_view name, const vector<string>& actions);
	void           enableGroup(string_view name, bool enable = true);
